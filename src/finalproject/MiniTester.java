...
//        for(Tile t : tiles){
//            System.out.println(tile2id.get(t) + " has neighbors:");
//            for(Tile s : t.neighbors)
//                System.out.println(tile2id.get(s));
//        }
    }
    ...
    public static boolean testNeighbors2() { // 1 points
        ...
        System.out.println(tiles.get(3));
        System.out.println(tiles.get(3).neighbors.size());
    ...
    public static boolean testRemoveMin() { // 3 points
        ...
        for (int j : a) {
            Tile t = q.removeMin();
//            System.out.println("j is "+j+ " and costEstimate is "+t.costEstimate);
            if (t.costEstimate != j)
                return false;
        }
    ...
    public static boolean testFindPath1Arg1() { // 2 points
        ...
        if (PathFindingService.g.computePathCost(path) != 2) {
